                    ...
                    <div class="box box-widget collapsed-box">
                        <div class="box-header with-border">
                            <div class="user-block">
                                <img class="img-circle" src="<?= base_url('assets') ?>/dist/img/avatar5.png" alt="Foto Profil">
                                <span class="username"><?= $mtr['judul'] ?> <a href="<?= base_url('index.php/guru/mapel/delete/') . $mtr['id'] . '/' . $idMapel ?>" class="tombol-yakin" data-isidata="Ingin menghapus materi ini?">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('index.php/guru/mapel/insert/') . $idMapel ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>File Materi <small>
                                <font color="red"><b>(Optional)</b></font>
                            </small></label>

  ...
  <aside class="main-sidebar" style="background-color: #023e8a;">
    <!-- sidebar: style can be found in sidebar.less -->
    <section class="sidebar" style="background-color: #023e8a;">
      <!-- Sidebar user panel -->
      <div class="user-panel" style="background-color: #023e8a;">
      ...
      <ul class="sidebar-menu" style="background-color: #023e8a;" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="background-color: #023e8a;">
